...
const itemsSlice = createSlice({
  ...
  initialState: {
    ...
    loading: { fetch: false, create: false }, // Implementing loading state for each api operation. This allows us to independently track loading states for each API operation.
  },
